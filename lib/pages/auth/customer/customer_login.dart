...
import 'package:delivery_app/model/request/customer_login_post_req.dart';
...
class _CustomerLoginState extends State<CustomerLogin> {
  ...
  Future<void> LoginButton() async {
    final loginRequest = CustomerLoginPostRequest(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => CustomerHome(user: res.user)),
        );
      } else {
